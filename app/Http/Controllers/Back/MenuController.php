...
class MenuController extends Controller
{
    public function index(Request $request){
        ...
        $blogs = [];
        // $blog_categories = Category::where('category_id', null)->where('for', 'blog')->active()->get();
        ...
        return view('back.frontend.menus.index', compact('menus', 'pages', 'blogs', 'menu_items'));
    }
    ...
    public function updateItem(Request $request){
        ...
        return redirect()->back()->with('success-alert', 'Menu item updated successfully.');
    }
}
