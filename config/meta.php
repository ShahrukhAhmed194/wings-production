...
return [
    ...
    */
    ...
    |
    */
	'description' => 'Alumni Association of Management Studies (AAMS) has formed in 2015 with the tremendous effort of the Alumnes of Management studies Department of Jagannath University when the accademic council of university has decided to form alumni body in every department. The vision while establishing AAMS was to develop the relationship, communication and bonding between the university and its alumnes who are now working in different area of the corporates and government level. The AAMS will make a bridge between the graduating students and the alumnes so that the graduets can get easy excess to the job market. Also the vision of AAMS is to help the university authority in organizing events and providing logistic support to the students.',
