...
@section('master')
<form action="{{route('back.committees.memberCreate', $committee->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-md-8">
            <div class="card border-light mt-3 shadow">
                <div class="card-header">
                    <h5 class="mb-0 d-inline-block">Create Committee Member of "{{$committee->name}}"</h5>

                    <a href="{{route('back.committees.edit', $committee->id)}}" class="btn btn-success btn-sm float-right"><i class="fas fa-arrow-left"></i> Back</a>
                </div>

                <div class="card-body">
                    <div class="form-group">
                        <label>Select Member*</label>
                        <select name="member" class="form-control form-control-sm selectpicker" data-live-search="true" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="designation" value="{{old('designation')}}">
                            </div>
                        </div>
