...
<div class="page_wrap">
    <div class="container-md">
        ...
        <form action="{{ route('back.festival.register.store',$festival->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="nike name" name="nick_name" value="{{old('nick_name')}}" required>
                            </div>
                        </div>
                        --}}
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="mobile number" name="phone_number" value="{{old('phone_number')}}" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><b>Session*</b></label>
                                <input type="text" class="form-control" placeholder="session" name="session" value="{{old('session')}}" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="number of person" min="1" max="10" name="number_of_person" value="1" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><b>Number of Guest *</b></label>
                                <input type="number" class="form-control" placeholder="number of guest" min="0" max="10" name="number_of_guest" value="0" >
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><b>Total Amount *</b></label>
                                <input type="number" class="form-control" placeholder="amount" step="any" name="payable_amount" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Bkash/Rocket/Manual" name="payment_type" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><b>Transaction No *</b></label>
                                <input type="text" class="form-control" placeholder="AB karim/ss1000" name="transaction_no" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Organization/Company" name="organization_name" value="{{old('organization_name')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="Phone No" name="organization_phone" value="{{old('organization_phone')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Organization/Company Address" name="organization_address" value="{{old('organization_address')}}">
                            </div>
                        </div>
                    </div>
