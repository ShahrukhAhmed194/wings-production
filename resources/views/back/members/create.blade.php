            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="last_name" value="{{old('full_name')}}" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="bengali_name" value="{{old('bengali_name')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="n_id" value="{{old('n_id')}}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="marital_status" class="form-control marital_status_input">
            ...
            <div class="married_section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><b>Date of Birth</b></label>
                            <input type="date" class="form-control" name="spouse_dob" value="{{old('spouse_dob')}}">
                        </div>
                    </div>
                    --}}
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kid_name[]" class="form-control fix-rounded-right" placeholder="Name of Kid">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mailing_city" value="{{old('mailing_city')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mailing_district" value="{{old('mailing_district')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mailing_post_code" value="{{old('mailing_post_code')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mailing_country" value="{{old('mailing_country')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="contact_no_res" value="{{old('contact_no_res')}}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="permanent_city" value="{{old('permanent_city')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="permanent_post_code" value="{{old('permanent_post_code')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="permanent_country" value="{{old('permanent_country')}}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="organization_designation" value="{{old('organization_designation')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="organization_phone" value="{{old('organization_phone')}}">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="payment_status" class="form-control" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <select name="member_type_id" class="form-control" required>
                            @foreach($member_types as $member_type)
                                <option value="{{$member_type->id}}">{{ $member_type->name.'-' .$member_type->amount}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label><b>Transaction Number/Ref.*</b></label>

                        <input type="text" class="form-control" placeholder="Ex: sslcommerze/AB karim/5432543" name="payment_trx_number" value="{{old('payment_trx_number')}}" required>
                    </div>
                </div>
