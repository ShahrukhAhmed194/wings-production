                                     ...
                                     <tr>
                                         <td align="center" height="0" style="border: 0; margin: 0; padding: 0; color: #ffffff; display: none !important; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; mso-hide: all !important; opacity: 0; overflow: hidden; visibility: hidden;">
                                              <span class="st-Delink st-Delink--preheader" style="color: #ffffff; text-decoration: none;">
                                                  <img src="{{$settings_g['logo'] ?? asset('img/default-img.png')}}" alt="" height="50"/><br>
                                              </span>
                                         </td>
                                     </tr>
                                    <tr>
                                       <td align="center" height="0" style="border: 0; margin: 0; padding: 0; color: #ffffff; display: none !important; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; mso-hide: all !important; opacity: 0; overflow: hidden; visibility: hidden;">
                                          <span class="st-Delink st-Delink--preheader" style="color: #ffffff; text-decoration: none;">
                                             Receipt from {{ env('APP_NAME') }} Amount paid BDT{{$payment_details['amount']}} Date paid {{$payment_details['date']}}
...
<!--                                             <img alt="" height="156" width="252" src="{{asset('public/img/stripe/Left.png')}}" style="display: block;border: 0;line-height: 100%;width: 100%;">
                                          ...
                                          <td class="Header-icon Target" style="background-color: #008000;border: 0;border-collapse: collapse;margin: 0;padding: 0;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;font-size: 0;line-height: 0px;mso-line-height-rule: exactly;background-size: 100% 100%; width: 96px !important;" align="center" height="156" valign="bottom">
                                             <a href="{{url("/")}}/" target="_blank" style="-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;outline: 0;text-decoration: none;">
<!--                                             <img alt="" height="156" width="96" src="{{asset('public/img/stripe/twelve_degree_icon@2x.png')}}" style="display: block;border: 0;line-height: 100%;">
                                             -->
                                             </a>
                                          </td>
...
<!--                                             <img alt="" height="156" width="252" src="{{asset('public/img/stripe/Right.png')}}" style="display: block;border: 0;line-height: 100%;width: 100%;">
                                          -->
                                          </td>
                                       </tr>
                                    </tbody>
